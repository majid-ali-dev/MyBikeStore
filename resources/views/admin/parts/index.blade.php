                                    ...
                                    @foreach ($parts as $part)
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="viewPartModalLabel">View Part Details
                                                        </h5>
                                                            ...
                                                            @else
                                                                <div class="no-image"
                                                                    ...
                                                                    <i class="fas fa-image"
                                                                        style="font-size: 48px; color: #999;"></i>
                                                                </div>
                                                            @endif
                                                        </div>
                                                        <p><strong>ID:</strong> {{ $part->id }}</p>
                                                        <p><strong>Name:</strong> {{ $part->name }}</p>
                                                        <p><strong>Price:</strong> ${{ number_format($part->price, 2) }}
                                                        </p>
                                                        <p><strong>Stock:</strong> {{ $part->stock }}</p>
                                                        <p><strong>Description:</strong> {{ $part->description ?? 'N/A' }}
                                                        </p>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="number" step="0.01" name="price"
                                                                    class="form-control" value="{{ $part->price }}"
                                                                    required>
                                                            </div>
                                                            <div class="mb-3">
                                        ...
                                        <div class="modal fade" id="deletePartModal-{{ $part->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form method="POST"
                                                        action="{{ route('admin.parts.destroy', $part->id) }}">
                                                        @csrf
                                                        @method('DELETE')
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="deletePartModalLabel">Confirm
                                                                Delete</h5>
